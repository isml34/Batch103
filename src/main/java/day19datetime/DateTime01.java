...
public class DateTime01 {
        public static void main(String[] args) {
            ...
            LocalDate dodveli = LocalDate.of(2013,2,8);
            Long diff = ChronoUnit.DAYS.between(dobAli, dodveli);
            ...
            Long aySayisi = ChronoUnit.MONTHS.between(istanbulunFethi, CumhuriyetinKurulus);
            System.out.println(aySayisi);//5645 ay
